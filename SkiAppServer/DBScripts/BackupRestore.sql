...
RESTORE DATABASE Ski_DB FROM DISK = 'C:\Users\User\source\repos\ShaharShalgi\SkiAppServer\SkiAppServer\DBScripts\backup.bak' WITH REPLACE,     --להחליף את זה לנתיב של קובץ הגיבוי
