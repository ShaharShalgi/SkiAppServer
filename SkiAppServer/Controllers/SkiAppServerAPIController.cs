...
namespace SkiAppServer.Controllers
{
    ...
    public class SkiAppServerAPIController : ControllerBase
    {
        ...
        [HttpPost("toggleUserAdmin")]
        public IActionResult ToggleUserAdmin(int userId, bool isAdmin)
        {
            try
            {
                // Check if admin is logged in
                ...
                bool success = context.ToggleUserAdmin(userId, isAdmin);
            ...
            {
                return BadRequest($"Error updating admin status: {ex.Message}");
            }
        }
        ...
        public IActionResult DeleteUser(int userId)
        {
            try
            {
                ...
                bool success = context.DeleteUserById(userId);
